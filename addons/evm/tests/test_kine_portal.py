...
class TestEvmKinePortal(HttpCase):
    ...
    def test_kine_portal_pages_show_case_list_and_detail(self):
        ...
        self.assertIn("evm-case-detail-layout", detail_response.text)
        self.assertIn("evm-case-detail-main", detail_response.text)
        self.assertIn("evm-case-detail-aside", detail_response.text)
